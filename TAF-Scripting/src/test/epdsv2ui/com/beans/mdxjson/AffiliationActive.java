...
public class AffiliationActive {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("effectiveDate", effectiveDate).append("terminationDate", terminationDate).append("additionalProperties", additionalProperties).toString();
    }
