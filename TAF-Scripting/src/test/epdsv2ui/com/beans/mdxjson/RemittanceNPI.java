...
public class RemittanceNPI {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("npiEligibilityType", npiEligibilityType).append("npiType", npiType).append("npiValue", npiValue).append("additionalProperties", additionalProperties).toString();
    }
